...
--
-- Table structure for table `dados_veiculo`
--
...
--
-- Dumping data for table `dados_veiculo`
--

LOCK TABLES `dados_veiculo` WRITE;
/*!40000 ALTER TABLE `dados_veiculo` DISABLE KEYS */;
INSERT INTO `dados_veiculo` VALUES (1,'QNV0000','222222',0,'AM','','fusca',0,'Tanque cheio'),(2,'QNV0000','222222',0,'AM','','fusca',0,'Tanque cheio'),(3,'QNV0000','222222',0,'AM','','fusca',0,'Tanque cheio');
